...
submit_cases = run_cases + [
    ...
    ("0987654321", 200.0, 0.0, 10.0, 190.0,
     "Cannot deposit zero or negative funds"),
...
def test(
    ...
    try:
        print(
            f"Inputs: account_number: {account_number}, initial_balance: {
                initial_balance:.2f}, deposit_amount: {deposit_amount:.2f}, withdraw_amount: {withdraw_amount:.2f}"
        )
