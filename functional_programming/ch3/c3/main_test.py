...
run_cases = [
    (
        "Higher-order functions and lambda expressions are key in functional programming.",
        {},
        ["functional", "lambda"],
        {
            "Higher-order functions and lambda expressions are key in functional programming.": [
    ...
    (
        "Deterministic results are achieved through referential transparency and the absence of side-effects.",
        {},
    ...
    (
        "Memoization helps optimize functional code by storing results of deterministic functions.",
        {},
...
submit_cases = run_cases + [
    ...
    (
        "Lambda functions provide a concise way to implement higher-order functions.",
        {},
        ["higher-order"],
        {
            "Lambda functions provide a concise way to implement higher-order functions.": [
...
def test(document, index, expected_keywords, expected_index):
    ...
    if len(result_keywords) == 0 and len(expected_keywords) != 0:
        print("Fail: keywords were changed in the global scope before testing")
        return False
